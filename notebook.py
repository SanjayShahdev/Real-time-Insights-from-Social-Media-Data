...
print('WW_trends:'),print('\n')
print(WW_trends)

print('\n'),print('='*50),print('\n')

print('US_trends:'),print('\n')
print(US_trends)
...
df = pd.DataFrame(data=retweets,columns=['Retweets','Favorites', 'Followers', 'ScreenName', 'Text']).groupby(['ScreenName','Text','Followers']).sum().sort_values(by=['Followers'],ascending=False)
